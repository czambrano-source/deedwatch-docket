...
function getInconsistencias(inmuebles: Inmueble[]): Inconsistencia[] {
  ...
  for (const i of inmuebles) {
    ...
    const depHasMain = !!i.Deposito__c && i.Deposito__c !== "No" && i.Deposito__c !== "0" && i.Deposito__c !== "SIN_DEPOSITO" && i.Deposito__c !== "N/A" && i.Deposito__c !== "No tiene";
    const depFields: { label: string; present: boolean }[] = [
      ...
      { label: "CHIP", present: !!i.chip_deposito__c && i.chip_deposito__c !== "-" && i.chip_deposito__c !== "SIN_CHIP" && i.chip_deposito__c !== "SIN_DEPOSITO" && i.chip_deposito__c !== "N/A" && i.chip_deposito__c !== "No tiene" },
    ];
